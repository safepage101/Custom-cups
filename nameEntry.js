document.getElementById('nameForm').addEventListener('submit', function (event) {
    ...
    fetch(`https://script.google.com/macros/s/AKfycbwAm7eybxuPELg__VEiyZJDwvkHA-T3ZenCBYrPfrkGvOBAq-aCntABrnLfoXE8I6IrXA/exec?name=${encodeURIComponent(capitalizedName)}&lastname=${encodeURIComponent(capitalizedLastname)}&device=${encodeURIComponent(deviceInfo)}&timestamp=${encodeURIComponent(timestamp)}`)
